        ...
        <div className="max-w-2xl mx-auto">
          <div className="bg-white rounded-2xl shadow-xl p-8 sm:p-12 animate-slideUp">
            {submitted && (
              <div className="mb-8 p-6 bg-green-50 border-2 border-green-200 rounded-xl flex items-start space-x-4 animate-slideUp">
                ...
                <div>
                  <h3 className="font-bold text-green-900 mb-2">Registration Successful!</h3>
                  <p className="text-green-800">Thank you for registering. We'll send you more details via email soon!</p>
                </div>
              </div>
            )}
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="animate-slideUp" style={{ animationDelay: '0.2s' }}>
                ...
                <select
                  ...
                  onChange={handleInputChange}
                  required
                  className="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:outline-none focus:border-primary-600 transition-colors appearance-none bg-white cursor-pointer"
                >
              ...
              <div className="animate-slideUp" style={{ animationDelay: '0.25s' }}>
                <label className="block text-sm font-bold text-gray-900 mb-4">Your Skills *</label>
                <p className="text-sm text-gray-600 mb-4">Select at least one skill</p>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  {skillOptions.map((skill) => (
                    <label key={skill} className="flex items-center space-x-3 p-3 border-2 border-gray-200 rounded-lg cursor-pointer hover:border-primary-600 hover:bg-primary-50 transition-all">
                      <input
                        type="checkbox"
              ...
              <div className="animate-slideUp" style={{ animationDelay: '0.3s' }}>
                <label className="block text-sm font-bold text-gray-900 mb-4">Interests *</label>
                <p className="text-sm text-gray-600 mb-4">Select what you're interested in</p>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  {interestOptions.map((interest) => (
                    <label key={interest} className="flex items-center space-x-3 p-3 border-2 border-gray-200 rounded-lg cursor-pointer hover:border-accent-500 hover:bg-amber-50 transition-all">
                      <input
                        type="checkbox"
              ...
              <div className="pt-4 border-t border-gray-200">
                <p className="text-center text-sm text-gray-600">
                  Questions? <a href="/contact" className="text-primary-600 font-semibold hover:underline">Contact us</a>
                </p>
              </div>
            </form>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
            {[
              ...
              <div
                key={idx}
                className="p-6 bg-gray-50 rounded-xl card-hover animate-slideUp"
