...
const Seasons = () => {
  ...
  return (
    <div className="w-full">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            {seasons.map((season, index) => (
              ...
              >
                <div className="h-full rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl transition-shadow duration-300 bg-white border border-gray-100">
                  {/* Header */}
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              {
                icon: <Cpu className="w-10 h-10 text-accent-500" />,
              ...
              <div
                key={idx}
                className="p-8 bg-white rounded-xl card-hover animate-slideUp"
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-4xl font-bold text-center text-gray-900 mb-16 animate-slideUp">
            Year-Round Schedule
          </h2>
              ...
              {[
                ...
                <div key={idx} className={`flex items-center animate-slideUp ${idx % 2 === 0 ? 'md:flex-row' : 'md:flex-row-reverse'}`} style={{ animationDelay: `${idx * 0.1}s` }}>
                  <div className="flex-1 md:text-right md:pr-8">
                    ...
                    <p className="text-gray-600 mt-2">{item.month}</p>
                  </div>
